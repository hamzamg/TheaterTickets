                        ...
                        <div class="flex flex-row justify-between p-2 overflow-hidden sm:rounded-lg">
                            <div class="w-1/4">
                                <input wire:model="search"
                                    class="block w-1/2 mt-1 border-gray-300 rounded-md shadow-sm focus:border-indigo-300 focus:ring focus:ring-indigo-200 focus:ring-opacity-50"
                            ...
                            <div class="content-start w-full mt-3 text-start sm:mt-0 sm:ml-4">
                                ...
                                <div class="mt-2">
                                    <div><label class=''><span
                                                ...
                                                type='text'
                                                class='mt-1  w-full rounded-md border-gray-300 shadow-sm @error('title')  border-red-500 @enderror focus:border-indigo-300 focus:ring focus:ring-indigo-200 focus:ring-opacity-50'
                                                wire:model='title'>
                                            @error('title')
                                    ...
                                    <div><label class='block'><span
                                                ...
                                                type='text'
                                                class='mt-1 block w-full rounded-md border-gray-300 shadow-sm @error('body')  border-red-500 @enderror focus:border-indigo-300 focus:ring focus:ring-indigo-200 focus:ring-opacity-50'
                                                wire:model='body'>
                                            @error('body')
                                                <span class='text-sm text-red-500'>{{ $message }}</span>
                                            @enderror
                                    ...
                                    <div><label class='block'><span
                                                ...
                                                class='mt-1 block w-full rounded-md border-gray-300 shadow-sm @error('photo_path')  border-red-500 @enderror focus:border-indigo-300 focus:ring focus:ring-indigo-200 focus:ring-opacity-50'
                                    ...
                                    <div><label class='block'><span
                                                ...
                                                type='text'
                                                class='mt-1 block w-full rounded-md border-gray-300 shadow-sm @error('lang')  border-red-500 @enderror focus:border-indigo-300 focus:ring focus:ring-indigo-200 focus:ring-opacity-50'
                                                wire:model='lang'>
                                            @error('lang')
                                                <span class='text-sm text-red-500'>{{ $message }}</span>
                                            @enderror
